...
public class kTSynapse_RLXX {
  ...
  private static void go2() {
    ...
    Netlist netlist = new kTSynapse5();

    String frequency = "100kHz";
    TransientConfig transientConfig = new TransientConfig("1000us", "500ns", new Square("VA", -0.5, "0", -0.5, frequency), new DC("Vy", 0));
  ...
  private static void go3() {
    ...
    Netlist netlist = new kTSynapse4();

    String frequency = "100kHz";
    TransientConfig transientConfig = new TransientConfig("1000us", "500ns", new Square("VB", 0.5, "0", 0.5, frequency),
        new Square("Vy", 0.5, "0", 0.5, frequency));
    netlist.setSimulationConfig(transientConfig);
    SimulationResult simulationResult = JSpice.simulate(netlist);
    SimulationPlotter.plot(simulationResult, "V(y)");
    SimulationPlotter.plot(simulationResult, "R(MA)", "R(MB)");
