...
public class TransientAnalysisV1MSSMem1D1 {

  public static void main(String[] args) {

    Netlist netlist = new V1MSSMemristor1D1();
    TransientConfig transientConfig = new TransientConfig(".04", ".001", new Sine("V1", 0.0, "0", 1.5, "100.0"));
