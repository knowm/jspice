...
import org.knowm.jspice.simulate.transientanalysis.driver.StreamingArbitrary;

/**
 * @author timmolter
 */
public class TestStreamingArbitraryDriver extends TestDrivers {
  ...
  public static void main(String[] args) {
    ...
    TestStreamingArbitraryDriver testDrivers = new TestStreamingArbitraryDriver();
  ...
  public void testArbitrary() {
    ...
    assertThat(xData.size()).isEqualTo(300);
