...
import org.knowm.jspice.simulate.transientanalysis.driver.Sawtooth;

/**
 * @author timmolter
 */
public class TestSawtoothDriver extends TestDrivers {
  ...
  public static void main(String[] args) {
    ...
    TestSawtoothDriver testDrivers = new TestSawtoothDriver();
    testDrivers.test();
  }
  ...
  public void test() {
    ...
    assertThat(y).isCloseTo(-3.799,  within(.01));
