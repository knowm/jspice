...
import org.knowm.jspice.component.element.memristor.MSSMemristorV1;
 ...
 * @author timmolter
 */
public class V1MSSMemV1 extends Netlist {
   ...
   * barrier potentials
   */
  private static final double V_OFF = .17;
  ...
  public V1MSSMemV1() {
    ...
    // define memristors
    Component m1 = new MSSMemristorV1("M1", 0.0, 1.0 / R_ON, 1.0 / R_OFF, N, TAU, V_ON, V_OFF, phi, schottkeyAlpha, schottkeyBeta, schottkeyAlpha, schottkeyBeta);
