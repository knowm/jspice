...
import org.knowm.jspice.component.element.memristor.MSSMemristorV3;
 ...
 * @author timmolter
 */
public class V1MSSMemV3 extends Circuit {
  ...
  // private final static double schottkeyAlpha = 0.0008; // N/A
  // private final static double schottkeyBeta = 4; // N/A
  // private final static double phi = .8;
  ...
  public V1MSSMemV3() {
    ...
    // define memristors
    Component m1 = new MSSMemristorV3("M1", R_INIT, R_ON, R_OFF, N, TAU, V_ON, V_OFF, phi, schottkeyAlpha, schottkeyBeta, schottkeyAlpha, schottkeyBeta);
